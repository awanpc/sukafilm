...
class Main extends React.Component {
  state = {
    ...
    total_pages: 1,
    page: 1,
    url: `https://api.themoviedb.org/3/genre/movie/list?api_key=8713a662b1e28abeaa3f31824bdb9f16&language=en-US`,
    moviesUrl: `https://api.themoviedb.org/3/discover/movie?api_key=8713a662b1e28abeaa3f31824bdb9f16&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1`,
    genre: "Comedy",
    genres: [],
    year: {
      label: "year",
  ...
  generateUrl = params => {
    ...
    const moviesUrl = `https://api.themoviedb.org/3/discover/movie?` +
      `api_key=8713a662b1e28abeaa3f31824bdb9f16&` +
